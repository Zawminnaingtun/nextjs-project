    ...
    return (
        <div className='flex'>
            <div className="w-1/2 p-10 h-screen mx-auto bg-[#0e1265] space-y-10 flex flex-col justify-center">
                ...
                <button className='bg-[#0070F3] w-full text-center text-white px-4 py-2 rounded-md'>Create a new account</button>
            </div>
            <div className="w-1/2 p-10 h-screen mx-auto space-y-10 flex items-center justify-center">
                <div className="w-4/5 space-y-5">
                    <h3 className="text-3xl font-bold">Sign in to Creative Coder Form</h3>
                    <div className="">
                    ...
                    <div className="">
                        <button className='bg-[#0070F3] w-full text-center text-white px-4 py-2 rounded-md'>Login</button>
                    </div>
                    <AuthForm />
                </div>
            </div>
